...
| 13 | [`13_ip_en_cuarentena.png`](screenshots/13_ip_en_cuarentena.png) | Vista de `Dashboard → Quarantine Monitor` mostrando la IP del atacante en cuarentena tras el intento de SQL Injection, con el tiempo restante de bloqueo. |
| 14 | [`14_dhcp_leases.png`](screenshots/14_dhcp_leases.png) | Vista de leases DHCP activos en VLAN10-USUARIOS mostrando al menos un cliente con IP asignada del rango, confirmando que el DHCP funciona. |
